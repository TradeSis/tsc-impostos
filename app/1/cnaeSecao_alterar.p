...
do on error undo:
    find cnaeSecao where cnaeSecao.idcnSecao = ttentrada.idcnSecao exclusive no-error.
    cnaeSecao.caracTrib = ttentrada.caracTrib. 
end.

create ttsaida.
ttsaida.tstatus = 200.
ttsaida.descricaoStatus = "cnaeSecao alterada com sucesso".
