...
if not avail caracTrib
then do:
    create ttsaida.
    ttsaida.tstatus = 400.
    ttsaida.descricaoStatus = "caracTrib nao encontrado".
...
do on error undo:
    find caracTrib where caracTrib.caracTrib = ttentrada.caracTrib exclusive no-error.
    caracTrib.descricaoCaracTrib = ttentrada.descricaoCaracTrib. 
end.

create ttsaida.
ttsaida.tstatus = 200.
ttsaida.descricaoStatus = "caracTrib alterada com sucesso".
