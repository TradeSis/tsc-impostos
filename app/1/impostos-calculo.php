...
if (isset($LOG_CAMINHO)) {
    ...
    $identificacao = date("dmYHis") . "-PID" . getmypid() . "-" . "impostos-calculo";
    if (isset($LOG_NIVEL)) {
        if ($LOG_NIVEL >= 1) {
            $arquivo = fopen(defineCaminhoLog() . "impostos-calculo_" . date("dmY") . ".log", "a");
        }
    }
}
if (isset($LOG_NIVEL)) {
...
$retorno = $progr->executarprogress("impostos/app/1/impostos-calculo", json_encode($jsonEntrada));
