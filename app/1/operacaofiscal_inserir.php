...
if (isset($LOG_CAMINHO)) {
    ...
    $identificacao = date("dmYHis") . "-PID" . getmypid() . "-" . "operacaofiscal_inserir";
    if (isset($LOG_NIVEL)) {
        if ($LOG_NIVEL >= 1) {
...
if (isset($jsonEntrada['idGrupo'])) {
    ...
    try {
        ...
        $retorno = $progr->executarprogress("impostos/app/1/operacaofiscal_inserir",json_encode($jsonEntrada));
