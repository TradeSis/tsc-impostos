...
if (isset($LOG_CAMINHO)) {
  ...
  $identificacao = date("dmYHis") . "-PID" . getmypid() . "-" . "produto_operacao";
  if (isset($LOG_NIVEL)) {
    if ($LOG_NIVEL >= 1) {
...
$retorno = $progr->executarprogress("impostos/app/1/produto_operacao", json_encode($jsonEntrada));
